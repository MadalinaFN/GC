...
namespace triunghi
{
    public partial class Form1 : Form
    {
        ...
        private void Draw_Click(object sender, EventArgs e)
        {
            ...
            grp.DrawLine(Pens.Green, Middle(points[0], points[1]), points[2]);
            grp.DrawLine(Pens.Green, Middle(points[1], points[2]), points[0]);
            grp.DrawLine(Pens.Green, Middle(points[0], points[2]), points[1]);
